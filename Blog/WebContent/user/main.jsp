	...
	<table style="padding: 5px" width="100%">
		<tr>
			<td style="padding-top: 16px" valign="middle" align="left" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>程序员博客系统</strong></font>
			</td>
			<td style="padding-top: 16px" valign="middle" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎用户：</strong>${blogger.nickName}</font>
			</td>
		</tr>
	</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎进入程序员管理系统</font></div>
		</div>
	</div>
</div>
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<div title="博客类别信息管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
		...
		<div title="评论管理"  data-options="iconCls:'icon-plgl'" style="padding:10px">
			...
			<a href="javascript:openTab('评论信息管理','commentManage.jsp','icon-plgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-plgl'" style="width: 150px;">评论信息管理</a>
				...
				<div title="链接管理"  data-options="iconCls:'icon-system'" style="padding:10px">
		...
		<div title="个人信息设置"  data-options="iconCls:'icon-grxx'" style="padding:10px">
		...
		<div title="退出"  data-options="iconCls:'icon-system'" style="padding:10px">
