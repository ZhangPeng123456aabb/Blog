...
<body class="easyui-layout">
	<div region="north"
		style="height: 60px; background-color: #E0ECFF; overflow: hidden">
		<table style="padding: 5px" width="100%">
			<tr>
				<td style="padding-top: 16px" valign="middle" align="left"
					width="50%"><font size="3">&nbsp;&nbsp;<strong>程序员博客系统</strong></font>
				</td>
				<td style="padding-top: 16px" valign="middle" align="right"
					width="50%"><font size="3">&nbsp;&nbsp;<strong>欢迎用户：</strong>${blogger.nickName}</font>
				</td>
			</tr>
		</table>
	</div>
		...
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div title="首页" data-options="iconCls:'icon-home'">
				<div align="center" style="padding-top: 100px">
					<font color="red" size="10">你好，管理员！欢迎进入系统后台。</font>
				</div>
			</div>
		</div>
	</div>
	<div region="west" style="width: 200px" title="导航菜单" split="true">
		<div class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="用户管理" data-options="iconCls:'icon-cycz'"
				style="padding: 10px;">
				<a href="javascript:openTab('用户管理','userManage.jsp','icon-grxxxg')"
					class="easyui-linkbutton"
			...
			<div title="链接管理" data-options="iconCls:'icon-system'"
				style="padding: 10px">
			...
			<div title="个人信息设置" data-options="iconCls:'icon-grxx'"
				style="padding: 10px">
				<a
			...
			<table cellspacing="8px">
				...
				<tr>
					...
					<td><input type="password" id="newPassword" name="newPassword"
						clas="easyui-validatebox" required="true" style="width: 200px" /></td>
				</tr>

				<tr>
					<td>确认新密码：</td>
					<td><input type="password" id="newPassword2"
						name="newPassword2" clas="easyui-validatebox" required="true"
						style="width: 200px" /></td>
				</tr>
			</table>
		</form>
