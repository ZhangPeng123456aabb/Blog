...
<form action="${pageContext.request.contextPath}/blogger/register.do" method="post" onsubmit="return checkForm()">
	<DIV style="background: rgb(255, 255, 255); margin: -200px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 400px; text-align: center;">
		...
		<P style="padding: 10px 0px 10px; position: relative;">
	  	...
	  	<P style="padding: 10px 0px 10px; position: relative;">
	  		<SPAN class="p_logo"></SPAN>    
			<INPUT id="repassword" name="repassword" class="ipt"  type="password" placeholder="请确认密码" value="">   
	  	</P>
	  	<P style="padding: 10px 0px 10px; position: relative;">
			<SPAN class="p_logo"></SPAN>
			<INPUT id="email" name="email" class="ipt"  type="text" placeholder="请输入邮箱" value="">   
	  	</P>
	  	<P style="padding: 10px 0px 10px; position: relative;">
			<SPAN class="p_logo"></SPAN>
			<INPUT id="nikeName" name="nikeName" class="ipt"  type="text" placeholder="请确认昵称" value="">   
	  	</P>
		<DIV style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			<P style="margin: 0px 35px 20px 45px;">
			<SPAN style="float: left;"><a href="${pageContext.request.contextPath}/index.html">程序员博客系统-注册</a></SPAN> 
			<span><font color="red" id="error">${erroInfo}</font></span>
	        <SPAN style="float: right;"> 
	              <input type="submit" style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" value="用户注册"/> 
	         </SPAN>         
	         </P>
	    </DIV>
	</DIV>
